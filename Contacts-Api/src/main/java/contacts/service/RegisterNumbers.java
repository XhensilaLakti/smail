...
public class RegisterNumbers {
	...
	public void AddContacts() throws FileNotFoundException {
		...
		// kontakte=Arrays.asList(new
		// ListaEKontakteve(input.next(),input.next(),input.nextLong()));
		/*
		 * ListaEKontakteve kontakt = new ListaEKontakteve(); kontakt.setName("Emri" +
		 * i); kontakt.setSurname("Mbiemri" + i); kontakt.setPhoneNr(1L);
